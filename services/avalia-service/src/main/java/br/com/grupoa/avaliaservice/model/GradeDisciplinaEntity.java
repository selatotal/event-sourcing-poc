...
@Entity(name = "grade_disciplina")
public class GradeDisciplinaEntity {
    ...
    public GradeDisciplinaEntity() {
    }

    public GradeDisciplinaEntity(String codigoGradeDisciplina, String codigoGrade, String codigoDisciplina, String periodo, String nomeGrade, String nomeDisciplina, Integer cargaHoraria, String codigoCurso, String nomeCurso) {
